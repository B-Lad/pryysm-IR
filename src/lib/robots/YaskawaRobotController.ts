 ...
 * FIXED: SLA/Dental methods moved inside class body; log prefix corrected to [YASKAWA]
 */
...
export class YaskawaRobotController extends RobotController {
  ...
  async removeBuildPlatform(printerId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Removing build platform from SLA printer ${printerId}`);
  ...
  async openDoor(printerId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Opening door for printer ${printerId}`);
  ...
  async closeDoor(printerId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Closing door for printer ${printerId}`);
  ...
  async transferBasket(fromStation: string, toStation: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Transferring basket from ${fromStation} to ${toStation}`);
  ...
  async loadWash(stationId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Loading basket into wash station ${stationId}`);
  ...
  async unloadWash(stationId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Unloading basket from wash station ${stationId}`);
  ...
  async loadCure(stationId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Loading basket into cure station ${stationId}`);
  ...
  async unloadCure(stationId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Unloading basket from cure station ${stationId}`);
  ...
  async inspectDentalModels(printerId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Inspecting dental models from printer ${printerId}`);
  ...
  async cleanPlatform(printerId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Cleaning build platform for printer ${printerId}`);
  ...
  async refillResin(printerId: string, parameters?: any): Promise<RobotResponse> {
    console.log(`[YASKAWA] Refilling resin for printer ${printerId}`);
