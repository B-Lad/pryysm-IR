...
import { RobotService } from '@/lib/robots/RobotService';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validTaskTypes = [
      'PART_REMOVAL', 'BED_PREP', 'INSPECTION', 'MATERIAL_LOAD',
      'BUILD_PLATFORM_REMOVAL', 'DOOR_OPEN', 'DOOR_CLOSE', 'BASKET_TRANSFER',
      'WASH_LOAD', 'WASH_UNLOAD', 'CURE_LOAD', 'CURE_UNLOAD',
      'DENTAL_MODEL_INSPECTION', 'PLATFORM_CLEANING', 'RESIN_REFILL'
    ];
